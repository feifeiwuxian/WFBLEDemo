...
//      let max =  self.peripheral?.maximumWriteValueLength(for: CBCharacteristicWriteType.withoutResponse)
//        print("最大写入个数\(max ?? 0)")
//        data?.subdata(in: Range<Data.Index>)
//        data?.withUnsafeBytes({ (<#UnsafePointer<ContentType>#>) in
//            <#code#>
//        })
//        var a:UInt8 = 0x00
